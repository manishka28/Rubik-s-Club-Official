    ...
    <div className='w-full overflow-hidden'>
      ...
      <div className='relative flex flex-col items-center justify-center w-full h-full mb-10'>
        ...
        <div className='flex flex-row gap-4 mt-4 justify-center'>
          <button className='bg-primaryRed text-white rounded-lg px-4 py-2'>
            Upcoming Events
          </button>
          <button className='bg-primaryRed text-white rounded-lg px-4 py-2'>
            Past Events
        ...
        <Slider ref={sliderRef} {...settings}>
          {events.map((event, index) => (
            <div key={index} className='px-2'>
              <div className='card shadow-xl py-10' style={cardStyle}>
                ...
                <div className='card-body text-white items-center px-4'>
                  ...
                  <div className='card-actions'>
                    <button className='bg-primaryRed text-white rounded-lg my-4 px-3 py-2'>
                      {event.buttonText}
                    </button>
                  </div>
                </div>
